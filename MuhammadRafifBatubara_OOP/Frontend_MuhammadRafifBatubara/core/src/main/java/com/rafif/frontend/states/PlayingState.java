...
import com.rafif.frontend.*;
import com.rafif.frontend.commands.Command;
import com.rafif.frontend.commands.JetpackCommand;
import com.rafif.frontend.factories.CoinFactory;
import com.rafif.frontend.factories.ObstacleFactory;
import com.rafif.frontend.observers.ScoreUIObserver;
import com.rafif.frontend.obstacles.BaseObstacle;
import com.rafif.frontend.obstacles.HomingMissile;
import com.rafif.frontend.states.DifficultyTransitionState;
import com.rafif.frontend.states.GameOverState;
import com.rafif.frontend.states.GameState;
import com.rafif.frontend.states.GameStateManager;
import com.rafif.frontend.strategies.*;
...
//            obstacle.render(shapeRenderer);
    ...
    private void spawnCoins() {
        ...
        if (!coinPatterns.isEmpty()) {
            CoinPattern pattern =
                coinPatterns.get(random.nextInt(coinPatterns.size()));
